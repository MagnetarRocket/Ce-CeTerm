...
/* static char *mouse_h_sccsid = "%Z% %M% %I% - %G% %U% ";  */
...
*     blank_mcursor    -   Switch to the mouse cursor
*
***************************************************************/
...
/***************************************************************
*  This variable keeps track of which cursor is currently
*  displayed.
***************************************************************/

#define   CURSOR_NOT_SET   -1
#define   NORMAL_CURSOR     0 
#define   BLANK_CURSOR      1 
